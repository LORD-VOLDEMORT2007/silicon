class Game {
   ...
   async start(){
    ...
    play(){
      ...
      console.log("ron1: " +  Ron1.y)
      console.log("bullet: " + ron2bullet.y)

      var Mock = (ron2bullet.x + ron2bullet.velocityX)
      var Mock2 = (ron1bullet.x + ron1bullet.velocityX)

      if (Mock < Ron1.x + Ron1.width &&
        Mock + ron2bullet.width > Ron1.x &&
        ron2bullet.y < Ron1.y + Ron1.height &&
        ron2bullet.height + ron2bullet.y > Ron1.y){
      ...
      else if ((Mock2 < Ron2.x + Ron2.width &&
        Mock2 + ron1bullet.width > Ron2.x &&
        ron1bullet.y < Ron2.y + Ron1.height &&
        ron1bullet.height + ron1bullet.y > Ron2.y)){
